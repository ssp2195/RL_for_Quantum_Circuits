...
class AncillaDeferredSearch:
    ...
    def _archive_key(self, state: HybridState) -> tuple[object, ...]:
        ...
        # Canonical Clifford scalar lift plus raw ordered rotations is exact.
        # The projective Clifford-extraction key must not be paired with an
        # unadjusted phase. Raw exact equality is conservative but sound.
